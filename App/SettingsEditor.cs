...
namespace NProcessing.App
{
    public partial class SettingsEditor : Form
    {
        ...
        readonly UserSettings _settingsTemp = new();
        ...
        private void SettingsEditor_Load(object sender, EventArgs e)
        {
            ...
            _settingsTemp.LockUi = Settings.LockUi;
            _settingsTemp.Vkey = Settings.Vkey;
            _settingsTemp.MidiInDevice = Settings.MidiInDevice;
        ...
        void Ok_Click(object sender, EventArgs e)
        {
            if (_changed)
            {
                ...
                Settings.LockUi = _settingsTemp.LockUi;
                Settings.Vkey = _settingsTemp.Vkey;
                Settings.MidiInDevice = _settingsTemp.MidiInDevice;
