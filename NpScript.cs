...
namespace NProcessing
{
    public partial class ScriptCore
    {
        ...
        public void colorMode(int mode, double max = 255) { NProcessing.color.SetMode(mode, max, max, max, max); }
        public void colorMode(int mode, int max1, int max2, int max3, int maxA = 255) { NProcessing.color.SetMode(mode, max1, max2, max3, maxA); }
